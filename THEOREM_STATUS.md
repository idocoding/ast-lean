...
- `Theorem`: finite involution substrate and boundary/interior partition in
  [Level0.lean](AST_levels/Foundation/Level0.lean)
...
- `Theorem`: correction-step monotonicity and iterate nonincrease in
  [Level1_Correction.lean](AST_levels/Foundation/Level1_Correction.lean)
- `Theorem`: beta-flow fixed-point structure in
  [Level1_BetaFlow.lean](AST_levels/Foundation/Level1_BetaFlow.lean)

## Interpretation

- `Theorem`: Boolean event-logic exclusion in
  [Level2_QuantumResults.lean](AST_levels/Interpretation/Level2_QuantumResults.lean)
...
- `Bridge`: Hilbert-space and Born-rule emergence packages are represented in
  [Level2_QuantumBridge.lean](AST_levels/Interpretation/Level2_QuantumBridge.lean)
- `Bridge`: manifold/spacetime emergence is represented canonically in
  [Level2_ManifoldBridge.lean](AST_levels/Interpretation/Level2_ManifoldBridge.lean)
  and
  [Level2_SpacetimeBridge.lean](AST_levels/Interpretation/Level2_SpacetimeBridge.lean),
  with the established classical route bundled in
  [Level2_GeometryRoute.lean](AST_levels/Interpretation/Level2_GeometryRoute.lean)
  and an internal Hurwitz-based `d = 3` support path packaged in
  [Level2_ManifoldBridge.lean](AST_levels/Interpretation/Level2_ManifoldBridge.lean)
- `Bridge`: inflation interpretation formulas are represented in
  [Level2_InflationBridge.lean](AST_levels/Interpretation/Level2_InflationBridge.lean)

## Physics

- `Bridge`: GR large-scale limit and Lovelock route in
  [Level3_GRBridge.lean](AST_levels/Physics/Level3_GRBridge.lean)
  and
  [Level3_GeometryRoute.lean](AST_levels/Physics/Level3_GeometryRoute.lean)
- `Theorem`: LQG kinematical comparison package in
  [Level3_LQG.lean](AST_levels/Physics/Level3_LQG.lean)
- `Theorem`: tensor-mode counting used by the inflation paper in
  [Level3_TensorModes.lean](AST_levels/Physics/Level3_TensorModes.lean)
- `Theorem`: soliton/worldsheet kinematics in
  [Level3_Soliton.lean](AST_levels/Physics/Level3_Soliton.lean)
- `Theorem`: Hurwitz / no-fifth-force package in
  [Level3_Hurwitz.lean](AST_levels/Physics/Level3_Hurwitz.lean)
...
- `Theorem`: holographic entropy package H1-H6 and Newton-constant matching in
  [Holography.lean](AST_levels/Applications/Holography.lean)
- `Theorem`: corrected fine-structure denominator
  `1/α = 4πσ_min - log 2 - 1/2`, corrected positivity, and tight corrected window in
  [AlphaEstimate.lean](AST_levels/Applications/AlphaEstimate.lean)
- `Bridge`: inflation observables package in
  [Inflation.lean](AST_levels/Applications/Inflation.lean)
- `Theorem`: proton-stability package in
  [ProtonStability.lean](AST_levels/Applications/ProtonStability.lean),
...
|---|---|---|---|
| `β = 1` shell/growth control | `Theorem` | [Level1_BetaFlow.lean](AST_levels/Foundation/Level1_BetaFlow.lean) and the promoted geometry bridge layer | This is the AST-side rate/growth input. |
| polynomial-growth to manifold emergence | `Bridge` | [Level2_ManifoldBridge.lean](AST_levels/Interpretation/Level2_ManifoldBridge.lean) | This currently depends on the classical Gromov/Kleiner polynomial-growth bridge. |
| strict Huygens to `d = 3` | `Bridge` | [Level2_SpacetimeBridge.lean](AST_levels/Interpretation/Level2_SpacetimeBridge.lean) | This currently depends on the classical Hadamard-Gunther theorem together with the AST-to-Huygens bridge. |
| internal Hurwitz support for `d = 3` | `Theorem` | [Level3_Hurwitz.lean](AST_levels/Physics/Level3_Hurwitz.lean) and [Level2_ManifoldBridge.lean](AST_levels/Interpretation/Level2_ManifoldBridge.lean) | This gives an internal quaternion-based `3`-support path alongside the classical bridge route. |
| GR uniqueness in `3+1` dimensions | `Bridge` | [Level3_GRBridge.lean](AST_levels/Physics/Level3_GRBridge.lean) | This currently depends on Lovelock as a cited classical theorem after the manifold and dimension bridges are in place. |
